    ...
    <main className="min-h-screen bg-[#050014] text-white">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <a
              href="https://clothiq-five.vercel.app/"
              target="_blank"
            ...
            <a
              href="https://github.com/Ayush-Coder077/Ecommerce_Website"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-3 h-20 rounded-full border border-white/10 bg-black/30 hover:bg-purple-600 transition"
            >
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8">
            ...
            <p className="text-gray-300 leading-8">
              CLOTHIQ is a full-stack fashion e-commerce platform
              designed to provide a seamless online shopping
              experience. Users can browse products, manage their
              cart, securely authenticate, place orders, and make
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8">
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li>✅ OTP Verification with SendGrid</li>
        ...
        <div className="mt-10 bg-white/5 border border-white/10 rounded-3xl p-8">
          ...
          <p className="text-gray-300 leading-8">
           One of the key challenges was implementing secure user
            authentication and payment processing while maintaining
            a smooth user experience. JWT authentication, OTP
            verification using SendGrid, and Stripe payment webhooks
            were integrated to ensure security, reliability, and
            scalability.
